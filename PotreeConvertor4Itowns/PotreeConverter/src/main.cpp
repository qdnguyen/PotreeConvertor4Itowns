...
//#include "coordinate_conversions.cpp"
...
Arguments parseArguments(int argc, char **argv){
	...
	desc.add_options() 
        ...
        ("projection,r", po::value<string>(&a.projection), "Doing conversion")
    ...
    if(!vm.count("projection")) a.projection= vm["projection"].as<string>();
